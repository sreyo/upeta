...
$(document).ready(function() {
  ...
  var dt =  $("#example").DataTable( {
        ...
        "serverSide": false,
        "sort": "position",
        "ajax": "${pageContext.request.contextPath}/DatabaseAdminServlet",
        "aoColumnDefs": [
...
<div class="col-sm-12 float-right">
	<a href="#addEmployeeModal" class="btn btn-info btn-xs " data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Database</span></a>
</div></div>
<div class="row spc">
<div class="col-sm-12 ">
<form action="">
