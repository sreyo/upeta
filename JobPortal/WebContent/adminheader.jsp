		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
 				    ...
 				    <li><a href="${pageContext.request.contextPath}/newdashboard.jsp"><span class="glyphicon glyphicon-globe"></span>  Applicants</a></li>
                    <li ><a href="${pageContext.request.contextPath}/suborganization.jsp"><span class="glyphicon glyphicon-dashboard"></span> Clients</a></li>
					<li><a href="${pageContext.request.contextPath}/adminpayment.jsp"><span class="glyphicon glyphicon-cloud"></span> Vendors</a></li>
