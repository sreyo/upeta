...
function format ( d ) {var len = d.filename.length;var i;var str="";
for(i=0;i<len;i++){
	str += '<ul class="list-group"> <li class="list-group-item   list-style-type: square;"> '+d.filename[i]+'   <a href="download1.jsp?filename='+d.filename[i]+'"  class="flag"><span class="glyphicon glyphicon-download"></span></a> </li></ul>'
}

    return 'Email ID: '+d.email+'<br>'+
...
$(document).ready(function() {
  ...
  var dt =  $("#example").DataTable( {
        ...
        "serverSide": false,
        "sort": "position",
        "ajax": "${pageContext.request.contextPath}/SeekersrchAdminServlet",
        "aoColumnDefs": [
